                                        ...
                                        {{-- {{-- <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6"> --}}
                                          ...
                                          <div class="sm:col-span-4">
                                            ...
                                            <div class="mt-2">
                                              <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                                <span class="flex select-none items-center pl-3 text-gray-500 sm:text-sm"></span>
                                                <input type="text" name="taskname" id="username" autocomplete="username" class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" value="{{$fill[0]->task_name}}" >
                                              </div>
                                            </div>
                                          </div>
                                          ...
                                          <div class="col-span-full">
                                            ...
                                            <div class="mt-2">
                                              <textarea id="about" name="desc" rows="3" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" >{{$fill[0]->task_description}}</textarea>
                                            </div>
                                          ...
                                          <div class="sm:col-span-4">
                                            ...
                                            <div class="mt-2">
                                              <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                                <span class="flex select-none items-center pl-3 text-gray-500 sm:text-sm" ></span>
                                                <input type="text" name="taskstatus" id="taskstatus" autocomplete="username" class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="" value="{{$fill[0]->current_status}}">
                                              </div>
                                            </div>
                                          </div>
                                          <div class="sm:col-span-3">
                                            ...
                                            <div class="mt-2">
                                              <select id="role" name="Role" autocomplete="country-name" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6" value="{{$fill[0]}}">
                                            ...
                                            <div class="sm:col-span-3">
                                              ...
                                              <div class="mt-2" style="padding: 10px;">
                                                ...
                                                <div>
                                                  ...
                                                  <p style="padding: 12px;">Due Date: <input type="text" name ="enddate" id="datepicker1" style="background-color: gainsboro;" value="{{$fill[0]->deadline}}"></p>
                                                  <p style="padding: 12px;">Task Creates At: <input type="text" name ="enddate" id="createdate" style="background-color: gainsboro;" value="{{$fill[0]->created_at}}"></p>
                                                </div>
