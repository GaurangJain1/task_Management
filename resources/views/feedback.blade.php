...
<x-layout>
    <x-slot:heading>
     Feedback and Task Ratting
    </x-slot:heading>
        <h1>This is <b> Feedback Section</b></h1>
        ...
        <form action="{{route('taskPost')}}" method="post">
              ...
              <div class="border-b border-gray-900/10 pb-12">
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                  <div class="sm:col-span-4">
                    ...
                    <div class="mt-2">
                      <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                        ...
                        <input type="text" name="taskid" id="username" autocomplete="username" class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" value="{{$task->task_id}}">
                      </div>
                    </div>
                  </div>
                  <div class="sm:col-span-4">
                    ...
                    <div class="mt-2">
                      <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                        <span class="flex select-none items-center pl-3 text-gray-500 sm:text-sm"></span>
                        <input type="text" name="taskname" id="username" autocomplete="username" class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" value="{{$task->task_name}}">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-span-full">
                    <label for="about" class="block text-sm font-medium leading-6 text-gray-900">Task FeedBack</label>
                    <div class="mt-2">
                    ...
                    <p class="mt-3 text-sm leading-6 text-gray-600">Please provide feedback for the task.</p>
                  </div>
          ...
          {{-- 
            ...
            {{-- <div class="ratting"> --}}
                <p class="rating">Give Rattings</p>
                <div data-coreui-allow-clear="true" data-coreui-toggle="rating" data-coreui-value="3"></div>
            {{-- </div> --}}
          
            <div>
              <p>Date: <input type="text" name ="enddate" id="datepicker1"></p>
            </div>
